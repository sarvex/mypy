...
def report_missing_attribute(
    ...
    if not mx.msg.prefer_simple_messages() and may_be_awaitable_attribute(
        name, typ, mx, override_info
    ):
...
def analyze_instance_member_access(
    ...
    info = override_info if override_info else typ.type
    if (
...
def analyze_class_attribute_access(
    ...
    (for generic classes).
    """
    info = override_info if override_info else itype.type
